      ...
      >
        <div className="w-full flex flex-col md:flex-row items-start gap-10">
          ...
          >
            ...
            >
              Solicita el Kit Digital con Nosotros
            </motion.h2>
            <p className="text-gray-600 mt-4 mb-18 md:mb-0 capitalize">
              Completa el siguiente formulario y descubre cómo {" "}
              <span className="font-bold uppercase">GENERA Digital</span> puede ayudarte a crecer.
            </p>
          </motion.div>
          ...
          >
            <form className="space-y-4">
              ...
              >
                ...
                <span className="pl-4 lg:text-[1em] lg:pl-8 text-[0.6em] md:text-[0.6em] uppercase">Quiero mi Bono Digital</span>
              </motion.button>
              </div>
            </form>
          </motion.div>
