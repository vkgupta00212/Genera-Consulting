    ...
    <div className='py-[100px] px-[20px] md:px-[40px] bg-black '>
      ...
      <div className='mt-[44px]'>
        ...
        <p className='md:hidden text-[20px] text-white text-center'>
          Si buscas reimaginar los límites con soluciones digitales y dar el siguiente paso hacia una transformación real, en Genera estamos preparados para ser tu aliado tecnológico. <br /> <span className='uppercase'>Este es solo el principio de nuestra historia y queremos que formes parte de ella.</span>
        </p>
