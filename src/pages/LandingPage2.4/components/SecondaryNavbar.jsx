...
const SecondaryNavigation = () => {
  return (
    <div className="sm:flex z-30  fixed top-[115px] md:top-[98px] w-[98%] mx-auto  justify-between bg-[#111111] rounded-[15px] px-2 sm:px-[30px] py-3">
      <div className='hidden sm:flex justify-center items-center'>
        <img src={Logo1} alt="Logo" className='w-[34px] h-[34.43px] ' />
      </div>

      <div className='flex gap-2.5 justify-evenly sm:justify-between items-center p- '>
