...
const SecondaryNavigation = () => {
  return (
    <div className="sm:flex sticky top-[115px] sm:top-[97px] z-30 justify-between m-2 bg-white rounded-[15px] border border-[#eeeeee] px-2 sm:px-[30px] py-3">
      <div className='hidden sm:flex justify-center items-center'>
        <img loading='lazy' src={Logo1} alt="Logo" className='w-[34px] h-[34.43px]' />
      </div>
