...
const ContactForm = ({ type = 'apple' }) => {
  const sectionRef = useRef(null);
  const isInView = useInView(sectionRef, { once: false, margin: "-100px" }); // Animation triggers when section is in view

  const brandContent = {
    apple: {
      title: "Aprovecha el Kit Digital para Estrenar un Apple",
      subtitle: <>Completa el siguiente formulario y descubre cómo <strong>GENERA</strong> Digital puede ayudarte a crecer.</>,
      contactText: "Solicitar mi Apple Subvencionado",
    },
    samsung: {
      title: "Aprovecha el Kit Digital para Estrenar un Samsung",
      subtitle: <>Completa el siguiente formulario y descubre cómo <strong>GENERA</strong> Digital puede ayudarte a crecer con tecnología Samsung.</>,
      contactText: "Solicitar mi Samsung Subvencionado",
    },
    hp: {
      title: "Aprovecha el Kit Digital para Estrenar un HP",
      subtitle: <>Completa el siguiente formulario y descubre cómo <strong>GENERA</strong> Digital puede ayudarte a crecer con tecnología HP.</>,
      contactText: "Solicitar mi HP Subvencionado",
    },
  };
            ...
            <form className="space-y-4">
              ...
              <div className="mt-1 md:mt-3 overflow-hidden">
                ...
                >
                  ...
                  <span className="pl-4 lg:text-[1em] lg:pl-8 text-[0.4em] md:text-[0.6em] uppercase">{content.contactText}</span>
                </motion.button>
              </div>
            </form>
          </motion.div>
