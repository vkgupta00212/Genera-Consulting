...
const WorkWithUs = ({ type = 'apple' }) => {
    ...
    const brandContent = {
        apple: {
            title: "¿Por qué pedir un ordenador Apple con Kit Digital?",
            benefits: [
                {
                    number: "01",
                    title: "Rendimiento. Rendimiento sobresaliente",
                    description: "para aplicaciones profesionales."
                },
                {
                    number: "02",
                    title: "Conocimiento iOS: Integración total",
                    description: "con el ecosistema iOS y macOS."
                },
                {
                    number: "03",
                    title: "Soporte: Soporte y garantías",
                    description: "oficiales."
                },
                {
                    number: "04",
                    title: "Subvención: Subvención de 1.000€ ",
                    description: "para reducir el coste."
                }
            ]
        },
        samsung: {
            ...
            benefits: [
                {
                    ...
                    image: bgOne, // Replace with actual image
                },
                {
                    number: "02",
                    title: "Innovación",
